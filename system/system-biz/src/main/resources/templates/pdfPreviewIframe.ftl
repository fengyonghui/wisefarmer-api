...
<script type="text/javascript">
    ...
    function openScanFile(title, token, bizNo, archivesNo) {
        //var pdfUrl ="http://127.0.0.1:8080/wisefarmer/generic/web/viewer.html?file="+encodeURIComponent("http://127.0.0.1:8080/wisefarmer/test/jeecgDemo/getPdfUrl?title="+encodeURI(title));
